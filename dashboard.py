...
sentiment_dimension_descriptions = {
    ...
    "Empathy": (
        "Crew politeness, general behavior, and special care given to Seniors, PWDs, and pregnant women.",
        {
            ...
            "action_moderate": "Look at the feedback to identify which specific customer relations aspects—like general politeness or specialized care for vulnerable passengers—need improvement to address these interactions and elevate passenger care.",
